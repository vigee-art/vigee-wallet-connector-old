...
var MyAlgoConnectWallet = /*#__PURE__*/function () {
  function MyAlgoConnectWallet() {
    this.accounts = [];
    this.defaultAccount = 0;
    this.walletConn = new MyAlgo();
  }

  MyAlgoConnectWallet.displayName = function displayName() {
    return "My Algo";
  };

  var _proto = MyAlgoConnectWallet.prototype;

  _proto.displayName = function displayName() {
    return MyAlgoConnectWallet.displayName();
  };

  MyAlgoConnectWallet.img = function img(inverted) {
...
var WC = /*#__PURE__*/function () {
  ...
  WC.displayName = function displayName() {
...
(function (ValidWallets) {
  ValidWallets["WALLET_CONNECT"] = "wallet-connect";
  ValidWallets["ALGO_SIGNER"] = "algo-signer";
  ValidWallets["MYALGO_CONNECT"] = "my-algo-connect";
})(ValidWallets || (ValidWallets = {}));

var ValidNetworks;

(function (ValidNetworks) {
  ValidNetworks["TEST"] = "TestNet";
  ValidNetworks["MAIN"] = "MainNet";
  ValidNetworks["VIGEE_DEV"] = "vigee-art-sandnet";
...
(function (WalletStorageKeys) {
  WalletStorageKeys["WALLET_PREFERENCE"] = "wallet-preference";
  WalletStorageKeys["ACCOUNT_LIST"] = "acct-list";
  WalletStorageKeys["ACCOUNT_PREFERENCE"] = "acct-preference";
})(exports.WalletStorageKeys || (exports.WalletStorageKeys = {}));

var VigeeWallet = /*#__PURE__*/function () {
  function VigeeWallet(network, popupPermissionCallback, walletChoice) {
  ...
  var _proto = VigeeWallet.prototype;
  ...
  _proto.setAccountList = function setAccountList(accts) {
    sessionStorage.setItem(exports.WalletStorageKeys.ACCOUNT_LIST, JSON.stringify(accts));
  };

  _proto.accountList = function accountList() {
    var accts = sessionStorage.getItem(exports.WalletStorageKeys.ACCOUNT_LIST);
  ...
  _proto.setAccountIndex = function setAccountIndex(idx) {
    ...
    sessionStorage.setItem(exports.WalletStorageKeys.ACCOUNT_PREFERENCE, idx.toString());
  };

  _proto.accountIndex = function accountIndex() {
    var idx = sessionStorage.getItem(exports.WalletStorageKeys.ACCOUNT_PREFERENCE);
  ...
  _proto.setWalletPreference = function setWalletPreference(walletChoice) {
    ...
    sessionStorage.setItem(exports.WalletStorageKeys.WALLET_PREFERENCE, walletChoice);
  };

  _proto.walletPreference = function walletPreference() {
    console.log(exports.WalletStorageKeys.WALLET_PREFERENCE);
    var wp = sessionStorage.getItem(exports.WalletStorageKeys.WALLET_PREFERENCE);
    return wp === null ? "" : wp;
  };

  _proto.disconnect = function disconnect() {
    if (this.wallet !== undefined) this.wallet.disconnect();
    sessionStorage.setItem(exports.WalletStorageKeys.ACCOUNT_LIST, "");
    sessionStorage.setItem(exports.WalletStorageKeys.ACCOUNT_PREFERENCE, "");
    sessionStorage.setItem(exports.WalletStorageKeys.WALLET_PREFERENCE, "");
  };
...
exports.VigeeWallet = VigeeWallet;
