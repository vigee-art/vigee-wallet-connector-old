...
var DynamicWallet = /*#__PURE__*/function () {
  function DynamicWallet(network, walletChoice, popupPermissionCallback) {
    ...
    if (!isImplementedWallet(this._walletChoice)) {
      this._walletChoice = exports.Wallets.PeraWallet;
    }
  ...
  _proto.setStoredAccountPreference = function setStoredAccountPreference(idx) {
    ...
    localStorage.setItem(exports.StorageKeys.ACCOUNT_PREFERENCE.concat(this.walletChoice), idx.toString());
  };

  _proto.storedAccountPreference = function storedAccountPreference() {
    var idx = localStorage.getItem(exports.StorageKeys.ACCOUNT_PREFERENCE.concat(this.walletChoice));
