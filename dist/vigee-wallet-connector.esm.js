...
})(StorageKeys || (StorageKeys = {})); // export interface Wallet {
//     accounts: string[];
...
var AlgoSignerWallet = /*#__PURE__*/function () {
  ...
  _proto.disconnect = function disconnect() {
    localStorage.removeItem(StorageKeys.ACCOUNT_PREFERENCE);
  };
...
var DynamicWallet = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = _context.t0 === Wallets.PeraWallet ? 5 : 8;
              break;
  ...
  _proto.storedAccountList = function storedAccountList() {
    var accts = localStorage.getItem(StorageKeys.ACCOUNT_LIST);
  ...
  _proto.storedAccountPreference = function storedAccountPreference() {
    var idx = localStorage.getItem(StorageKeys.ACCOUNT_PREFERENCE);
  ...
  _proto.storedWalletPreference = function storedWalletPreference() {
    var wp = localStorage.getItem(StorageKeys.WALLET_PREFERENCE);
  ...
  _proto.storedNetworkPreference = function storedNetworkPreference() {
    var wp = localStorage.getItem(StorageKeys.NETWORK_PREFERENCE);
...
export { DynamicWallet, Networks, StorageKeys, Wallets };
