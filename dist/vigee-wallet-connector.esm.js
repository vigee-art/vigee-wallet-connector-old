...
})(WalletStorageKeys || (WalletStorageKeys = {}));
...
var VigeeWallet = /*#__PURE__*/function () {
  ...
  _proto.accountList = function accountList() {
    var accts = sessionStorage.getItem(WalletStorageKeys.ACCOUNT_LIST);
  ...
  _proto.accountIndex = function accountIndex() {
    var idx = sessionStorage.getItem(WalletStorageKeys.ACCOUNT_PREFERENCE);
...
export { VigeeWallet, WalletStorageKeys, allowedWallets };
//# sourceMappingURL=vigee-wallet-connector.esm.js.map
