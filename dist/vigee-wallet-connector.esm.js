...
var DynamicWallet = /*#__PURE__*/function () {
  ...
  _proto.accountList = function accountList() {
    var accts = sessionStorage.getItem(StorageKeys.ACCOUNT_LIST);
  ...
  _proto.accountIndex = function accountIndex() {
    var idx = sessionStorage.getItem(StorageKeys.ACCOUNT_PREFERENCE);
  ...
  _proto.walletPreference = function walletPreference() {
    var wp = sessionStorage.getItem(StorageKeys.WALLET_PREFERENCE);
    return wp === null ? Wallets.PeraWallet : wp;
  };

  _proto.networkPreference = function networkPreference() {
    var wp = sessionStorage.getItem(StorageKeys.NETWORK_PREFERENCE);
